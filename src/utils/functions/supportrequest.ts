...
export async function isRequestSuitable(
  ...
  const sysPrompt = [
    ...
    "The content may not be in English or may be written in poor English — do your best to understand it, and ensure your response is easy to read for a wide range of users.",
    ...
    "If the user's request suggests that they are asking for help or reporting something with a server unrelated to the official nypsi server or the nypsi discord bot, tell the user that this support is only for the official server and the discord bot, not their server.",
    "",
    ...
    "* Asking for help but not saying what they need help with",
    "",
    "",
  ];

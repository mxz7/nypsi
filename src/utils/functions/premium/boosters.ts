    ...
    await addNotificationToQueue({
      ...
      payload: {
        embed: new CustomEmbed(
          null,
          "thank you for boosting the nypsi server, you can see your rewards [here](https://discord.com/channels/747056029795221513/1031950370206924903/1089545304099016765)"
        )

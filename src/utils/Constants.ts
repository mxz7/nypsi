...
export default {
  ...
  MARKET_CHANNEL_ID: "1008467335973179482",
  TRADES_CHANNEL_ID: "1375496301617086676",
  ...
  EMOJI_REGEX: /^(<a?:?[A-Za-z0-9_~-]+:[0-9]+>|:[A-Za-z0-9_~-]+:)$/,
  UNICODE_EMOJI_REGEX:
  ...
  HIGHROLLER_REQUIREMENT: 500,
  SUPPORTER_ROLE: "1353716448220020838",
  EVIDENCE_BASE: 30000000, // 30MB
  CRASH_CHANNEL: "1300561687975432272",
  WHITELISTED_BOTS: ["974297735559806986"] as string[],
  Z_CHANNELS: ["1316836441204068463", "1391083857004068955"],
  LOOT_RAIN_ALLOWED_CHANNELS: [
    "747057312468041791",
    "1246517047161257984",
    "1246517145136009427",
    "1246517338174656552",

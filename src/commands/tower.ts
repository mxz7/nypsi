...
const payoutsData = new Map<string, number[]>([
  ["easy", [0.93, 1.12, 1.39, 1.76, 2.28, 2.95, 3.88, 5.14, 6.72]],
  ["medium", [1, 1.3, 1.74, 2.36, 3.26, 4.51, 6.3, 8.88, 12.34]],
  ["hard", [1.14, 1.69, 2.57, 3.94, 6.12, 9.49, 14.86, 23.44, 36.47]],
  ["expert", [1.55, 3.11, 6.35, 12.94, 26.66, 54.78, 113.62, 237.74, 500]],
]);

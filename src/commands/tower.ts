...
const payoutsData = new Map<string, number[]>([
  ["easy", [0.93, 1.14, 1.41, 1.78, 2.31, 2.99, 3.93, 5.2, 6.79]],
  ["medium", [1, 1.32, 1.76, 2.39, 3.3, 4.57, 6.37, 8.98, 12.47]],
  ["hard", [1.14, 1.71, 2.6, 3.99, 6.2, 9.6, 15.03, 23.7, 36.85]],
  ["expert", [1.55, 3.15, 6.43, 13.1, 26.98, 55.42, 114.9, 240.3, 500]],
]);

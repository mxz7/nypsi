...
const payoutsData = new Map<string, number[]>([
  ["easy", [0.93, 1.3, 1.6, 2, 2.52, 3.18, 4.01, 5.08, 6.41]],
  ["medium", [1, 1.51, 2, 2.67, 3.59, 4.84, 6.52, 8.78, 11.8]],
  ["hard", [1.14, 1.96, 2.94, 4.44, 6.72, 10.17, 15.37, 23.18, 34.93]],
  ["expert", [1.55, 3.59, 7.22, 14.54, 29.22, 58.61, 117.45, 235.17, 500]],
]);

...
async function run(message, args) {
    ...
    const embed = new CustomEmbed(message.member, false, `**worth** $${bitcoin.worth.toLocaleString()}\n**owned** ${bitcoinAmount} ($${(bitcoinAmount * bitcoin.worth).toLocaleString()})`).setFooter("not real bitcoin, although it reflects current worth in USD")
